...
class Kegiatan extends CI_Controller {
	...
	function index(){
		...
		$qd   =$this->db->query("SELECT LEFT(nama_kegiatan,30) nama_kegiatan,jenis_kegiatan,LEFT(nama_gedung,25) nama_gedung,lantai,nama_ruang,tanggal,tanggal2,jam,tp.penyelenggara,keterangan
									FROM tb_kegiatan tk
									...
									OR tanggal2 BETWEEN '$tgl1' AND '$tgl2'
